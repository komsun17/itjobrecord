            ...
            data.response.forEach(function (item, index){
                tableData.push([    
                    ...
                    `<div class="btn-group" role="group">
                        <a href="form-edit.php?id=${item.u_id}" type="button" class="btn btn-warning btn-sm text-white">
                            <i class="far fa-edit"></i> แก้ไข
                        </a>
                        <button type="button" class="btn btn-danger btn-sm" id="delete" data-id="${item.u_id}" data-index="${index}">
