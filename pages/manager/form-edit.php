                                    ...
                                    <div class="row">
                                        <div class="col-md-6 px-1 px-md-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="last_name" id="last_name" placeholder="นามสกุล" value="<?php echo $data['lastname']; ?>" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="bg-light p-2 shadow-sm"><?php echo $data['username']; ?></p>
                                            </div>
                                            <div class="form-group">
