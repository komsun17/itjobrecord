                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 px-1 px-md-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" name="emp_email" id="emp_email" placeholder="อีเมล" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="emp_section">Section</label>
                                                <input type="text" class="form-control" name="emp_section" id="emp_section" placeholder="แผนก" required>
                                            </div>
                                            <div class="form-group">
